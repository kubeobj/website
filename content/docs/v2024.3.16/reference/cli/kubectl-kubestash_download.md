...
menu:
  docs_v2024.3.16:
    identifier: kubectl-kubestash-download
    name: Download
...
## kubectl-kubestash download

Download components of a snapshot

### Synopsis

Download components of a snapshot from restic repositories

```
kubectl-kubestash download [flags]
```
