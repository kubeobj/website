...
- Learn how backup of workloads data works from [here](/docs/v2024.3.16/guides/workloads/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.3.16/guides/volumes/overview/).
