...
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2024.3.16/guides/volumesnapshot/pvc/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
<figure align="center">
  <img alt="Snapshots in GCP console" src="/docs/v2024.3.16/guides/volumesnapshot/pvc/images/gcp.png">
