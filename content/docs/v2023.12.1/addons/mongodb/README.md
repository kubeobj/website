...
url: /docs/v2023.12.1/addons/mongodb/
aliases:
- /docs/v2023.12.1/addons/mongodb/README/
info:
  cli: v0.32.0
  community: v0.32.0
  elasticsearch:
...
- [How does it work?](/docs/v2023.12.1/addons/mongodb/overview/) gives an overview of how backup and restore process for MongoDB database works in Stash.
- [Standalone MongoDB](/docs/v2023.12.1/addons/mongodb/standalone/) shows how to backup and restore a standalone MongoDB database.
- [MongoDB ReplicaSet](/docs/v2023.12.1/addons/mongodb/replicaset/) shows how to backup & restore  a MongoDB ReplicaSet.
- [Sharded MongoDB Cluster](/docs/v2023.12.1/addons/mongodb/sharding/) shows how to backup & restore a sharded MongoDB cluster.
