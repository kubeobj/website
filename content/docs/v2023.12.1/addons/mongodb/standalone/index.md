...
> Note: YAML files used in this tutorial are stored [here](https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples).
...
```console
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples/mongodb.yaml
...
Here, we have to use service `sample-mongodb` and secret `sample-mongodb-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2023.12.1/concepts/crds/appbinding/) crd that holds the necessary information to connect with the database.
...
```console
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples/repository.yaml
...
```console
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples/backupconfiguration.yaml
...
```console
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples/restore/standalone/restored-mongodb.yaml
...
```console
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/mongodb/standalone/examples/restore/standalone/restoresession.yaml
