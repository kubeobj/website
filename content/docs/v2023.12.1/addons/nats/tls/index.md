...
- Install Stash in your cluster following the steps [here](/docs/v2023.12.1/setup/install/stash/).
- Install cert-manager in your cluster following the instruction [here](https://cert-manager.io/docs/installation/).
- If you are not familiar with how Stash backup and restore NATS streams, please check the following guide [here](/docs/v2023.12.1/addons/nats/overview/).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2023.12.1/concepts/crds/appbinding/)
- [Function](/docs/v2023.12.1/concepts/crds/function/)
- [Task](/docs/v2023.12.1/concepts/crds/task/)
- [BackupConfiguration](/docs/v2023.12.1/concepts/crds/backupconfiguration/)
- [BackupSession](/docs/v2023.12.1/concepts/crds/backupsession/)
- [RestoreSession](/docs/v2023.12.1/concepts/crds/restoresession/)
...
> Note: YAML files used in this tutorial are stored [here](https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples).
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples/clusterissuer.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples/ca.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples/issuer.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples/cert.yaml
...
This addon should be able to take backup of the NATS streams with matching major versions as discussed in [Addon Version Compatibility](/docs/v2023.12.1/addons/nats/README#addon-version-compatibility).
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/tls/examples/appbinding.yaml
appbinding.appcatalog.appscode.com/sample-nats-tls created
```

### Prepare Backend

We are going to store our backed up data into a GCS bucket. So, we need to create a Secret with GCS credentials and a `Repository` object with the bucket information. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2023.12.1/guides/backends/overview/).
...
```bash
$ kubectl create -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/tls/examples/repository.yaml
...
```bash
$ kubectl create -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/tls/examples/backupconfiguration.yaml
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.12.1/addons/nats/tls/images/sample-nats-backup.png">
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/tls/examples/restoresession.yaml
