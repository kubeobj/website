...
> Note: YAML files used in this tutorial are stored [here](https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/helm/examples).
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/nats/helm/examples/appbinding.yaml
...
```bash
$ kubectl create -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/helm/examples/repository.yaml
...
```bash
$ kubectl create -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/helm/examples/backupconfiguration.yaml
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.12.1/addons/nats/helm/images/sample-nats-backup.png">
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/addons/nats/helm/examples/restoresession.yaml
