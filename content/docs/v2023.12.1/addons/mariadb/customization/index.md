...
> Note: YAML files used in this tutorial are stored [here](https://github.com/kubestash/docs/tree/{{< param "info.version" >}}/docs/addons/mariadb/customization/examples).
...
To know more about the available options for retention policies, please visit [here](/docs/v2023.12.1/concepts/crds/backupconfiguration/#specretentionpolicy).
