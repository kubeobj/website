...
`spec.task` specifies the name and parameters of the [Task](/docs/v2023.12.1/concepts/crds/task/) crd to use to restore the target data.
...
- Learn how restore of workloads data works from [here](/docs/v2023.12.1/guides/workloads/overview/).
- Learn how restore of databases works from [here](/docs/v2023.12.1/guides/addons/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2023.12.1/guides/volumes/overview/).
