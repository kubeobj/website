...
> **Note:** YAML files used in this tutorial are stored in  [docs/guides/platforms/aks/examples](/docs/v2023.12.1/guides/platforms/aks/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
<figure align="center">
  <img alt="Backup data in Azure Blob Storage Container" src="/docs/v2023.12.1/guides/platforms/aks/images/aks.png">
