...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2023.12.1/guides/monitoring/overview/images/monitoring-structure.svg">
...
The following instruction show example of enabling monitoring in Stash for the Prometheus server deployed with Prometheus Operator. You can check the [Builtin Prometheus](/docs/v2023.12.1/guides/monitoring/prom-builtin/) scraper guide if you are managing your Prometheus server manually.
...
$ helm install kubestash oci://ghcr.io/appscode-charts/kubestash \
  ...
  --set kubestash-operator.monitoring.agent=prometheus.io/operator \
  --set kubestash-operator.monitoring.backup=true \
  --set kubestash-operator. monitoring.operator=true \
  --set kubestash-operator.monitoring.serviceMonitor.labels.release=prometheus-stack \
...
$ helm template kubestash oci://ghcr.io/appscode-charts/kubestash \
  ...
  --set kubestash-operator.monitoring.backup=true \
  --set kubestash-operator.monitoring.operator=true \
  --set kubestash-operator.monitoring.serviceMonitor.labels.release=prometheus-stack | kubectl apply -f -
```
