...
$ helm install kubestash oci://ghcr.io/appscode-charts/kubestash \
  ...
  --set kubestash-operator.monitoring.agent=prometheus.io/builtin \
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/monitoring/prom-builtin/examples/prom-rbac.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/monitoring/prom-builtin/examples/prom-config.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/monitoring/prom-builtin/examples/prom-deployment.yaml
...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2023.12.1/guides/monitoring/prom-builtin/images/prom_builtin_target.png">
...
To uninstall Stash follow this [guide](/docs/v2023.12.1/setup/README).
