...
- Learn how to configure automatic backup for workloads from [here](/docs/v2023.12.1/guides/auto-backup/workload/).
- Learn how to configure automatic backup for PVCs from [here](/docs/v2023.12.1/guides/auto-backup/pvc/).
- Learn how to configure automatic backup for databases from [here](/docs/v2023.12.1/guides/auto-backup/database/).
