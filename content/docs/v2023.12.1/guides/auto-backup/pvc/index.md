...
>**Note:** YAML files used in this tutorial are stored in  [docs/guides/auto-backup/pvc/examples](/docs/v2023.12.1/guides/auto-backup/pvc/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/v2023.12.1/setup/README).
