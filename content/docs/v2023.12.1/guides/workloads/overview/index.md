...
1. See a step by step guide to backup/restore volumes of a Deployment [here](/docs/v2023.12.1/guides/workloads/deployment/).
2. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v2023.12.1/guides/workloads/statefulset/).
3. See a step by step guide to backup/restore a Daemonset's volumes [here](/docs/v2023.12.1/guides/workloads/daemonset/).
