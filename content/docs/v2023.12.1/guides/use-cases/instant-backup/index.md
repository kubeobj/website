...
>**Note:** YAML files used in this tutorial are stored in  [docs/guides/use-cases/instant-backup/examples](/docs/v2023.12.1/guides/use-cases/instant-backup/examples) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/use-cases/instant-backup/examples/deployment.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/use-cases/instant-backup/examples/repository.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/use-cases/instant-backup/examples/backupconfiguration.yaml
...
```bash
$ kubectl apply -f https://github.com/kubestash/docs/raw/{{< param "info.version" >}}/docs/guides/use-cases/instant-backup/examples/backupsession.yaml
