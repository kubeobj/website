...
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/deployment/examples](/docs/v2023.12.1/guides/volumesnapshot/deployment/examples/) directory of [kubestash/docs](https://github.com/kubestash/docs) repository.
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2023.12.1/guides/volumesnapshot/deployment/images/gcp.png">
